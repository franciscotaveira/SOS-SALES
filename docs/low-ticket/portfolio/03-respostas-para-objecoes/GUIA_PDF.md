...
Este kit foi desenhado para vendedor, autônomo ou dono que atende pessoalmente pelo WhatsApp. Formato possível: biblioteca pesquisável e versão em documento, com campos editáveis, contexto de uso e regra de encerramento. Ele ajuda a produzir: **Alternativas para preço, comparação, prazo, confiança e decisão compartilhada; sem pressão artificial**. O kit não instala ferramentas nem opera contas do comprador.
