...
- **Resultado comprado:** Retomadas por motivo e contexto conhecido, com critérios para escolher quem contatar e quando parar.
- **Origem no catálogo:** grupo 1, ID 04.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “retomadas por motivo e contexto conhecido, com critérios para escolher quem contatar e quando parar” com um modelo finito que você copia, preenche e usa em um caso real.
