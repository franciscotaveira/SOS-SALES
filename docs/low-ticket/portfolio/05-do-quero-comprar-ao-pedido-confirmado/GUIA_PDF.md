# Do “quero comprar” ao pedido confirmado

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para vendedor, autônomo ou dono que atende pessoalmente pelo WhatsApp. Formato possível: biblioteca pesquisável e versão em documento, com campos editáveis, contexto de uso e regra de encerramento.. Ele ajuda a produzir: **Mensagens para resumir escolha, combinar entrega, orientar pagamento e confirmar o pedido conforme seu status real**. O kit não instala ferramentas nem opera contas do comprador.
...
1. Escolha uma situação real e escreva o contexto que já é conhecido.
2. Defina o objetivo da próxima mensagem antes de redigir o texto.
3. Escreva uma versão curta, com uma ação clara e uma condição de parada.
4. Teste com um exemplo fictício e registre o que precisou ser adaptado.
5. Aprove somente mensagens que respeitam preço, disponibilidade e limites reais da empresa.
...
Não enviar automaticamente, não inventar preço ou disponibilidade e não transformar o material em spam.
