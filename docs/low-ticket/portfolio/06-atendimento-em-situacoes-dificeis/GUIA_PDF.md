# Atendimento em situações difíceis

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para vendedor, autônomo ou dono que atende pessoalmente pelo WhatsApp. Formato possível: biblioteca pesquisável e versão em documento, com campos editáveis, contexto de uso e regra de encerramento.. Ele ajuda a produzir: **Respostas para atraso, indisponibilidade, erro e reclamação, com encaminhamento ao responsável**. O kit não instala ferramentas nem opera contas do comprador.
