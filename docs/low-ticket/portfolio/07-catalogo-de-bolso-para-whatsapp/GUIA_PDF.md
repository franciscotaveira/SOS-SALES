# Catálogo de bolso para WhatsApp

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para prestador de serviço, pequeno comércio ou profissional independente. Formato possível: modelos editáveis com exemplo preenchido e instrução curta.. Ele ajuda a produzir: **Páginas de produtos/serviços com fotos, descrição, preço, condições e próximo passo**. O kit não instala ferramentas nem opera contas do comprador.
