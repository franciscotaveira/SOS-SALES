...
- **Resultado comprado:** Páginas de produtos/serviços com fotos, descrição, preço, condições e próximo passo.
- **Origem no catálogo:** grupo 2, ID 07.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “páginas de produtos/serviços com fotos, descrição, preço, condições e próximo passo” com um modelo finito que você copia, preenche e usa em um caso real.
