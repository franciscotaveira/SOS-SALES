...
- **Resultado comprado:** Modelo com itens, escopo, prazo, validade, condições e aceite.
- **Origem no catálogo:** grupo 2, ID 08.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “modelo com itens, escopo, prazo, validade, condições e aceite” com um modelo finito que você copia, preenche e usa em um caso real.
