# Apresentação de três opções

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para prestador de serviço, pequeno comércio ou profissional independente. Formato possível: modelos editáveis com exemplo preenchido e instrução curta. Ele ajuda a produzir: **Comparativo editável de versões essencial, intermediária e completa, com diferenças reais**. O kit não instala ferramentas nem opera contas do comprador.
