...
- **Origem no catálogo:** grupo 2, ID 09.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “comparativo editável de versões essencial, intermediária e completa, com diferenças reais” com um modelo finito que você copia, preenche e usa em um caso real.
