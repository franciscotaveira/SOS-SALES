# Portfólio com prova do trabalho

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para prestador de serviço, pequeno comércio ou profissional independente. Formato possível: modelos editáveis com exemplo preenchido e instrução curta.. Ele ajuda a produzir: **Estrutura de caso com problema, trabalho realizado, evidência autorizada e limites do resultado**. O kit não instala ferramentas nem opera contas do comprador.
...
1. Descreva o problema do cliente antes de apresentar a solução.
2. Liste entregáveis observáveis e explicite o que fica fora do escopo.
3. Registre premissas, dependências, prazo, investimento e validade.
4. Faça uma revisão por outra pessoa ou use a própria checklist antes de enviar.
5. Marque a próxima ação e a data de retorno no momento do envio.
...
Não prometer resultado financeiro, integração ou prazo que dependa de acesso ainda não fornecido.
