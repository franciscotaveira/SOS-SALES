...
- **Resultado comprado:** Estrutura de caso com problema, trabalho realizado, evidência autorizada e limites do resultado.
- **Origem no catálogo:** grupo 2, ID 10.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “estrutura de caso com problema, trabalho realizado, evidência autorizada e limites do resultado” com um modelo finito que você copia, preenche e usa em um caso real.
