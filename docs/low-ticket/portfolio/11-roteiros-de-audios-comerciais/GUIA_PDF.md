# Roteiros de áudios comerciais

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para prestador de serviço, pequeno comércio ou profissional independente. Formato possível: modelos editáveis com exemplo preenchido e instrução curta.. Ele ajuda a produzir: **Guias curtos para explicar preço, proposta e próximos passos sem gravar áudios longos**. O kit não instala ferramentas nem opera contas do comprador.
