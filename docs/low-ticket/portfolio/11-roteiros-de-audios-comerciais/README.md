...
- **Resultado comprado:** Guias curtos para explicar preço, proposta e próximos passos sem gravar áudios longos.
- **Origem no catálogo:** grupo 2, ID 11.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “guias curtos para explicar preço, proposta e próximos passos sem gravar áudios longos” com um modelo finito que você copia, preenche e usa em um caso real.
