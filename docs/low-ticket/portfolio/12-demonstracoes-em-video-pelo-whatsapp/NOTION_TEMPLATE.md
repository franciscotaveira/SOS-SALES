# Demonstrações em vídeo pelo WhatsApp — template duplicável
...
## Database principal: Demonstrações em vídeo pelo WhatsApp
...
- Propostas em rascunho; aguardando resposta; aceitas; vencidas; pedidos fora do escopo.
...
| Oferta | Cliente / segmento | Problema e objetivo | Entregáveis | Não incluído | Prazo e premissas | Investimento e validade | Próximo passo / aceite |
| --- | --- | --- | --- | --- | --- | --- | --- |
