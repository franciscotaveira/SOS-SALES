...
- **Resultado comprado:** Roteiros de gravação para produto, serviço e explicação de orçamento, com lista de cenas.
- **Origem no catálogo:** grupo 2, ID 12.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “roteiros de gravação para produto, serviço e explicação de orçamento, com lista de cenas” com um modelo finito que você copia, preenche e usa em um caso real.
