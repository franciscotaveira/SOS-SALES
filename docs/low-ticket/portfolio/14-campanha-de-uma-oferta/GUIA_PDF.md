# Campanha de uma oferta

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono de negócio, vendedor ou responsável por conteúdo. Os materiais entregam peças e rotinas; não incluem audiência, tráfego ou promessa de vendas. Ele ajuda a produzir: **Roteiro de preparação, abertura, esclarecimento e encerramento, com peças e datas editáveis**. O kit não instala ferramentas nem opera contas do comprador.
