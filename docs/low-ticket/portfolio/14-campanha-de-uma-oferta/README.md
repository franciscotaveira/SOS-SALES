...
- **Resultado comprado:** Roteiro de preparação, abertura, esclarecimento e encerramento, com peças e datas editáveis.
- **Origem no catálogo:** grupo 3, ID 14.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “roteiro de preparação, abertura, esclarecimento e encerramento, com peças e datas editáveis” com um modelo finito que você copia, preenche e usa em um caso real.
