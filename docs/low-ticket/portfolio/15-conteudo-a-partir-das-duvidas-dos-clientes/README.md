...
- **Resultado comprado:** Planilha para transformar perguntas reais em roteiros de conteúdo e chamadas para conversa.
- **Origem no catálogo:** grupo 3, ID 15.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “planilha para transformar perguntas reais em roteiros de conteúdo e chamadas para conversa” com um modelo finito que você copia, preenche e usa em um caso real.
