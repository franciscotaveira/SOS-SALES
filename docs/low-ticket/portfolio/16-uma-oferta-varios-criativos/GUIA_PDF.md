# Uma oferta, vários criativos

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono de negócio, vendedor ou responsável por conteúdo. Os materiais entregam peças e rotinas; não incluem audiência, tráfego ou promessa de vendas.. Ele ajuda a produzir: **Matriz de ângulos, roteiros de peças e ficha para registrar o teste**. O kit não instala ferramentas nem opera contas do comprador.
