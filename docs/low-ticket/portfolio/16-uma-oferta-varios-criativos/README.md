...
- **Resultado comprado:** Matriz de ângulos, roteiros de peças e ficha para registrar o teste.
- **Origem no catálogo:** grupo 3, ID 16.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “matriz de ângulos, roteiros de peças e ficha para registrar o teste” com um modelo finito que você copia, preenche e usa em um caso real.
