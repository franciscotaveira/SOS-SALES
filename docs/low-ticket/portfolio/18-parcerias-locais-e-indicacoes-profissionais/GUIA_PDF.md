# Parcerias locais e indicações profissionais

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono de negócio, vendedor ou responsável por conteúdo. Os materiais entregam peças e rotinas; não incluem audiência, tráfego ou promessa de vendas. Ele ajuda a produzir: **Apresentação de parceria, roteiro de contato individual pertinente e quadro de acompanhamento**. O kit não instala ferramentas nem opera contas do comprador.
...
1. Escolha uma oferta real que possa receber conversas.
2. Registre uma dúvida ou objeção observada, sem inventar a voz do público.
3. Crie um ângulo e um roteiro que levem a uma ação específica.
4. Publique uma peça e registre a origem das conversas recebidas.
5. Revise o que gerou conversa útil, não somente alcance.
...
Não prometer alcance, leads ou vendas. Não usar depoimentos, imagens ou dados sem autorização.
