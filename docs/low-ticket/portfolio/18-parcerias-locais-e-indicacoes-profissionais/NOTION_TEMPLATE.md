# Parcerias locais e indicações profissionais — template duplicável
...
## Database principal: Parcerias locais e indicações profissionais
...
- Calendário da oferta; pautas por dúvida; peças em produção; resultados por campanha.
...
| Oferta relacionada | Dúvida ou dor observada | Ângulo | Formato e canal | Roteiro / briefing | CTA e intenção esperada | Evidência e resultado | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
