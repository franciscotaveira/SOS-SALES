...
- **Origem no catálogo:** grupo 3, ID 18.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “apresentação de parceria, roteiro de contato individual pertinente e quadro de acompanhamento” com um modelo finito que você copia, preenche e usa em um caso real.
