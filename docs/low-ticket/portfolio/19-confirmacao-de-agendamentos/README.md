...
- **Resultado comprado:** Mensagens e rotina de confirmação com data, local, preparo fornecido pelo negócio e resposta esperada.
- **Origem no catálogo:** grupo 4, ID 19.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “mensagens e rotina de confirmação com data, local, preparo fornecido pelo negócio e resposta esperada” com um modelo finito que você copia, preenche e usa em um caso real.
