...
- **Resultado comprado:** Fluxos de conversa para escolher outra data, registrar motivo e esclarecer a política existente.
- **Origem no catálogo:** grupo 4, ID 20.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “fluxos de conversa para escolher outra data, registrar motivo e esclarecer a política existente” com um modelo finito que você copia, preenche e usa em um caso real.
