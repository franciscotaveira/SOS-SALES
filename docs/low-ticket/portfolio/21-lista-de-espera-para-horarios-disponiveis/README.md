...
- **Resultado comprado:** Quadro de interessados, critérios de convite e mensagens que só oferecem disponibilidade confirmada.
- **Origem no catálogo:** grupo 4, ID 21.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “quadro de interessados, critérios de convite e mensagens que só oferecem disponibilidade confirmada” com um modelo finito que você copia, preenche e usa em um caso real.
