# Conversa após uma falta

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para negócio de serviços com horários marcados. O conteúdo é operacional, sem aconselhamento clínico ou setorial regulado.. Ele ajuda a produzir: **Mensagens para compreender o ocorrido e oferecer reagendamento quando fizer sentido**. O kit não instala ferramentas nem opera contas do comprador.
