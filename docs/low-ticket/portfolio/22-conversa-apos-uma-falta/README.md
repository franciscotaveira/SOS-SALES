...
- **Origem no catálogo:** grupo 4, ID 22.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “mensagens para compreender o ocorrido e oferecer reagendamento quando fizer sentido” com um modelo finito que você copia, preenche e usa em um caso real.
