# Da consulta inicial à proposta de serviço

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para negócio de serviços com horários marcados. O conteúdo é operacional, sem aconselhamento clínico ou setorial regulado.. Ele ajuda a produzir: **Ficha de descoberta e roteiro para resumir necessidade, solução proposta e próximo passo**. O kit não instala ferramentas nem opera contas do comprador.
