...
- **Resultado comprado:** Ficha de descoberta e roteiro para resumir necessidade, solução proposta e próximo passo.
- **Origem no catálogo:** grupo 4, ID 23.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “ficha de descoberta e roteiro para resumir necessidade, solução proposta e próximo passo” com um modelo finito que você copia, preenche e usa em um caso real.
