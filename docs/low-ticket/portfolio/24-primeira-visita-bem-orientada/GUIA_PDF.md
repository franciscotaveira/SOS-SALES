# Primeira visita bem orientada

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para negócio de serviços com horários marcados. O conteúdo é operacional, sem aconselhamento clínico ou setorial regulado. Ele ajuda a produzir: **Modelos de boas-vindas, localização, documentos necessários e instruções práticas**. O kit não instala ferramentas nem opera contas do comprador.
