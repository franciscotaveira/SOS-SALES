...
- **Resultado comprado:** Roteiros e controle de indicações, com condições claras quando houver benefício.
- **Origem no catálogo:** grupo 5, ID 27.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “roteiros e controle de indicações, com condições claras quando houver benefício” com um modelo finito que você copia, preenche e usa em um caso real.
