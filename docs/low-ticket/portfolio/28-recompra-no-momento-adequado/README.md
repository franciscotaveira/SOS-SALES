...
- **Resultado comprado:** Matriz de ocasião de retorno, elegibilidade, exclusões e mensagens pertinentes.
- **Origem no catálogo:** grupo 5, ID 28.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “matriz de ocasião de retorno, elegibilidade, exclusões e mensagens pertinentes” com um modelo finito que você copia, preenche e usa em um caso real.
