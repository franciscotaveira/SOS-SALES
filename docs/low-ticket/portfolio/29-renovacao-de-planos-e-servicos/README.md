...
- **Origem no catálogo:** grupo 5, ID 29.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “calendário de vencimentos e mensagens que esclarecem continuidade, condições e decisão” com um modelo finito que você copia, preenche e usa em um caso real.
