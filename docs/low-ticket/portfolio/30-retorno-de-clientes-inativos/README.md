...
- **Resultado comprado:** Quadro de motivos de afastamento e abordagens específicas de reconexão.
- **Origem no catálogo:** grupo 5, ID 30.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “quadro de motivos de afastamento e abordagens específicas de reconexão” com um modelo finito que você copia, preenche e usa em um caso real.
