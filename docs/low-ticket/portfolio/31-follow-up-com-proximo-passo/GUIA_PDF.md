# Follow-up com próximo passo

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono, autônomo ou gestor de pequena equipe. Ferramentas com premissas editáveis, exemplo e instruções; sem depender de programação ou implantação individual.. Ele ajuda a produzir: **Quadro com responsável, contexto, próxima ação, prazo e motivo de encerramento**. O kit não instala ferramentas nem opera contas do comprador.
