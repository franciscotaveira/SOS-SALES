...
- **Resultado comprado:** Quadro com responsável, contexto, próxima ação, prazo e motivo de encerramento.
- **Origem no catálogo:** grupo 6, ID 31.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “quadro com responsável, contexto, próxima ação, prazo e motivo de encerramento” com um modelo finito que você copia, preenche e usa em um caso real.
