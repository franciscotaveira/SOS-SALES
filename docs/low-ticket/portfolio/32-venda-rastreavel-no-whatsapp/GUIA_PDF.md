# Venda rastreável no WhatsApp

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono, autônomo ou gestor de pequena equipe. Ferramentas com premissas editáveis, exemplo e instruções; sem depender de programação ou implantação individual.. Ele ajuda a produzir: **Registro de origem, oportunidade, venda e perda, preservando origem desconhecida**. O kit não instala ferramentas nem opera contas do comprador.
