...
- **Resultado comprado:** Registro de origem, oportunidade, venda e perda, preservando origem desconhecida.
- **Origem no catálogo:** grupo 6, ID 32.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “registro de origem, oportunidade, venda e perda, preservando origem desconhecida” com um modelo finito que você copia, preenche e usa em um caso real.
