...
Este kit foi desenhado para dono, autônomo ou gestor de pequena equipe. Ferramentas com premissas editáveis, exemplo e instruções; sem depender de programação ou implantação individual.. Ele ajuda a produzir: **Simulador do efeito de diferentes descontos sobre contribuição, usando custos informados**. O kit não instala ferramentas nem opera contas do comprador.
