...
- **Origem no catálogo:** grupo 6, ID 34.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “comparação de itens avulsos e pacotes com preço, custo e contribuição estimada” com um modelo finito que você copia, preenche e usa em um caso real.
