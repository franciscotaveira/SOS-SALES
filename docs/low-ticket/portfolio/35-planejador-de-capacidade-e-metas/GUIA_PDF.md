# Planejador de capacidade e metas

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono, autônomo ou gestor de pequena equipe. Ferramentas com premissas editáveis, exemplo e instruções; sem depender de programação ou implantação individual. Ele ajuda a produzir: **Simulação de atendimentos, capacidade, valor médio e cenários de conversão informados pelo usuário**. O kit não instala ferramentas nem opera contas do comprador.
...
1. Copie o modelo e preencha o exemplo antes de inserir dados reais.
2. Defina quais campos são obrigatórios para sua decisão.
3. Registre uma próxima ação ou um motivo explícito para encerrar.
4. Faça uma revisão semanal com números e amostra de registros.
5. Corrija o processo quando houver dados ausentes, não maquie o indicador.
...
Ferramenta manual não substitui CRM, integração ou CAPI. Não tratar correlação como atribuição causal.
