# Planejador de capacidade e metas — template duplicável
...
## Database principal: Planejador de capacidade e metas
...
- Hoje; atrasados; por canal; ganhos e perdas; revisão semanal; dados desconhecidos.
...
| Registro | Origem / canal | Etapa / status | Valor ou custo | Próxima ação | Data da próxima ação | Responsável | Resultado / motivo de perda |
| --- | --- | --- | --- | --- | --- | --- | --- |
