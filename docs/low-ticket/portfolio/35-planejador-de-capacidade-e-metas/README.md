...
- **Resultado comprado:** Simulação de atendimentos, capacidade, valor médio e cenários de conversão informados pelo usuário.
- **Origem no catálogo:** grupo 6, ID 35.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “simulação de atendimentos, capacidade, valor médio e cenários de conversão informados pelo usuário” com um modelo finito que você copia, preenche e usa em um caso real.
