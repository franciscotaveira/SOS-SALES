...
- **Resultado comprado:** Resumo de oportunidades, vendas, perdas e ações, com roteiro de reunião curta.
- **Origem no catálogo:** grupo 6, ID 36.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “resumo de oportunidades, vendas, perdas e ações, com roteiro de reunião curta” com um modelo finito que você copia, preenche e usa em um caso real.
