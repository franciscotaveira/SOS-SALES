...
- **Origem no catálogo:** grupo 7, ID 37.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “plano diário de aprendizagem, exercícios e critérios de prontidão para atender” com um modelo finito que você copia, preenche e usa em um caso real.
