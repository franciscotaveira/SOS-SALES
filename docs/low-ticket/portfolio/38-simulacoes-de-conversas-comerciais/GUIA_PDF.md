# Simulações de conversas comerciais

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono ou líder que precisa orientar vendedores. Formato possível: oficina gravada curta, fichas de prática e modelos preenchíveis. Ele ajuda a produzir: **Casos fictícios para praticar atendimento e ficha de observação com exemplos comentados**. O kit não instala ferramentas nem opera contas do comprador.
