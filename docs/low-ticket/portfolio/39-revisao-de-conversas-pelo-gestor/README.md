...
- **Resultado comprado:** Rubrica simples de clareza, contexto, informação correta e próximo passo.
- **Origem no catálogo:** grupo 7, ID 39.
- **Sobreposição:** Hipótese acrescentada ao catálogo; criar e validar do zero.

## Promessa de uma frase

> Resolva “rubrica simples de clareza, contexto, informação correta e próximo passo” com um modelo finito que você copia, preenche e usa em um caso real.
