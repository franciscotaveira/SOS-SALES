# Passagem de atendimento sem repetir perguntas

**Guia de aplicação — rascunho para validação**

## Para que serve

Este kit foi desenhado para dono ou líder que precisa orientar vendedores. Formato possível: oficina gravada curta, fichas de prática e modelos preenchíveis. Ele ajuda a produzir: **Ficha de transferência com histórico resumido, pendência, responsável e próxima ação**. O kit não instala ferramentas nem opera contas do comprador.
