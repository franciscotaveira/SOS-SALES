...
- **Resultado comprado:** Ficha de transferência com histórico resumido, pendência, responsável e próxima ação.
- **Origem no catálogo:** grupo 7, ID 40.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “ficha de transferência com histórico resumido, pendência, responsável e próxima ação” com um modelo finito que você copia, preenche e usa em um caso real.
