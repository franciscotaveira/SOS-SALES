# Proposta de automação com escopo fechado — template duplicável
...
## Database principal: Proposta de automação com escopo fechado
...
- Projetos por etapa; bloqueios; decisões pendentes; aceite; manutenção; escopo extra.
...
| Projeto / cliente | Etapa | Dependência | Responsável | Risco / decisão | Evidência / aceite | Suporte e atualização | Próximo passo |
| --- | --- | --- | --- | --- | --- | --- | --- |
