...
- **Resultado comprado:** Proposta preenchível com entregas, exclusões, responsabilidades e marcos.
- **Origem no catálogo:** grupo 8, ID 43.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “proposta preenchível com entregas, exclusões, responsabilidades e marcos” com um modelo finito que você copia, preenche e usa em um caso real.
