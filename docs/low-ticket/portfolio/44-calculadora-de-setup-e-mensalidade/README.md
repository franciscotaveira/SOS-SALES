...
- **Resultado comprado:** Planilha de trabalho inicial, consumo, suporte e cenários de contribuição.
- **Origem no catálogo:** grupo 8, ID 44.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “planilha de trabalho inicial, consumo, suporte e cenários de contribuição” com um modelo finito que você copia, preenche e usa em um caso real.
