...
- **Resultado comprado:** Formulário de descoberta, mapa de processos e critérios para avaliar viabilidade.
- **Origem no catálogo:** grupo 8, ID 45.
- **Sobreposição:** Comparar com EKO e Conversas Prontas antes de publicar.

## Promessa de uma frase

> Resolva “formulário de descoberta, mapa de processos e critérios para avaliar viabilidade” com um modelo finito que você copia, preenche e usa em um caso real.
