...
- **Origem no catálogo:** grupo 8, ID 46.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “checklist de dependências, responsáveis, validação por etapa e passagem de operação” com um modelo finito que você copia, preenche e usa em um caso real.
