...
- **Resultado comprado:** Roteiro de apresentação com cenário, evidência do funcionamento e limites do escopo.
- **Origem no catálogo:** grupo 8, ID 47.
- **Sobreposição:** Tema já apareceu na pesquisa interna; validar se há material existente.

## Promessa de uma frase

> Resolva “roteiro de apresentação com cenário, evidência do funcionamento e limites do escopo” com um modelo finito que você copia, preenche e usa em um caso real.
