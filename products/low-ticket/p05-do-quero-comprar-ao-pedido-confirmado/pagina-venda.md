...
> Responder com clareza, contexto e um próximo passo sem transformar a conversa em robô.

**Para quem é:** vendedor, autônomo ou dono que atende pelo WhatsApp.

## Você recebe
- Mensagens para resumir escolha, combinar entrega, orientar pagamento e confirmar o pedido conforme seu status real
...
1. Dor: resolva uma conversa comercial específica sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para vendedor, autônomo ou dono que atende pelo WhatsApp, com campos e limites claros.
