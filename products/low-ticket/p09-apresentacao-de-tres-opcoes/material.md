...
## Entrega incluída
Comparativo editável de versões essencial, intermediária e completa, com diferenças reais.
...
Você vai sair com um comparativo honesto entre essencial, recomendado e completo.

## Modelo preenchível
| Campo | Sua versão |
|---|---|
| Critério de escolha | [PREENCHER] |
| O que muda em cada opção | [PREENCHER] |
| Para quem serve | [PREENCHER] |
| Prazo | [PREENCHER] |
| Investimento | [PREENCHER] |
| Recomendação condicional | [PREENCHER] |

## Exemplo fictício
**Três opções:** uma empresa de manutenção residencial apresenta [SERVIÇO] para [PÚBLICO], inclui [ITEM CONFIRMADO], informa [PRAZO APROVADO] e convida a pessoa a [PRÓXIMO PASSO]. O exemplo é ilustrativo; substitua todos os dados antes de publicar.
