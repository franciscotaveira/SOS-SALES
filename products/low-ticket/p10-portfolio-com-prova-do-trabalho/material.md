...
## Entrega incluída
Estrutura de caso com problema, trabalho realizado, evidência autorizada e limites do resultado.
...
Você vai sair com uma prova estruturada sem inventar resultado.

## Modelo preenchível
| Campo | Sua versão |
|---|---|
| Contexto autorizado | [PREENCHER] |
| Problema | [PREENCHER] |
| Intervenção | [PREENCHER] |
| Evidência disponível | [PREENCHER] |
| Limite do relato | [PREENCHER] |
| Próximo passo | [PREENCHER] |

## Exemplo fictício
**Caso de trabalho:** uma empresa de manutenção residencial apresenta [SERVIÇO] para [PÚBLICO], inclui [ITEM CONFIRMADO], informa [PRAZO APROVADO] e convida a pessoa a [PRÓXIMO PASSO]. O exemplo é ilustrativo; substitua todos os dados antes de publicar.
