# Demonstrações em vídeo pelo WhatsApp
...
Apresentar uma oferta de forma simples para o cliente entender e decidir.

## Entrega incluída
Roteiros de gravação para produto, serviço e explicação de orçamento, com lista de cenas.
...
Você vai sair com um storyboard curto para mostrar uso e decisão.

## Modelo preenchível
| Campo | Sua versão |
|---|---|
| Cena 1: situação | [PREENCHER] |
| Cena 2: ação | [PREENCHER] |
| Cena 3: evidência | [PREENCHER] |
| Cena 4: limite | [PREENCHER] |
| Cena 5: próximo passo | [PREENCHER] |
| Legenda e CTA | [PREENCHER] |

## Exemplo fictício
**Demonstração em vídeo:** uma empresa de manutenção residencial apresenta [SERVIÇO] para [PÚBLICO], inclui [ITEM CONFIRMADO], informa [PRAZO APROVADO] e convida a pessoa a [PRÓXIMO PASSO]. O exemplo é ilustrativo; substitua todos os dados antes de publicar.
