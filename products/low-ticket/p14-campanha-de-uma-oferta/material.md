...
## Entrega incluída
Roteiro de preparação, abertura, esclarecimento e encerramento, com peças e datas editáveis.
...
Use a sequência **Campanha de uma oferta** como uma semana de teste. Uma peça precisa ter uma intenção observável: informar, esclarecer ou iniciar uma conversa.

| Dia | Intenção | Peça ou ação | Sinal observado |
|---:|---|---|---|
| 1 | Preparação | [PREENCHER] | [REGISTRAR] |
| 2 | Abertura | [PREENCHER] | [REGISTRAR] |
| 3 | Prova ou demonstração | [PREENCHER] | [REGISTRAR] |
| 4 | Objeção | [PREENCHER] | [REGISTRAR] |
| 5 | Convite | [PREENCHER] | [REGISTRAR] |
| 6 | Lembrete pertinente | [PREENCHER] | [REGISTRAR] |
| 7 | Encerramento real | [PREENCHER] | [REGISTRAR] |
