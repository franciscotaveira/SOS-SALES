...
## Entrega incluída
Planilha para transformar perguntas reais em roteiros de conteúdo e chamadas para conversa.
...
Use a sequência **Dúvidas dos clientes** como uma semana de teste. Uma peça precisa ter uma intenção observável: informar, esclarecer ou iniciar uma conversa.

| Dia | Intenção | Peça ou ação | Sinal observado |
|---:|---|---|---|
| 1 | Colete a pergunta | [PREENCHER] | [REGISTRAR] |
| 2 | Separe fato de hipótese | [PREENCHER] | [REGISTRAR] |
| 3 | Escolha o formato | [PREENCHER] | [REGISTRAR] |
| 4 | Escreva a resposta | [PREENCHER] | [REGISTRAR] |
| 5 | Inclua o próximo passo | [PREENCHER] | [REGISTRAR] |
| 6 | Publique e registre | [PREENCHER] | [REGISTRAR] |
| 7 | Revise o que voltou | [PREENCHER] | [REGISTRAR] |
