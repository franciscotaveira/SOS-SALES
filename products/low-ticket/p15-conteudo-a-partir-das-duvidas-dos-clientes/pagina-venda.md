...
**Para quem é:** dono de negócio, vendedor ou responsável por conteúdo.
...
1. Dor: resolva uma oferta que precisa começar conversas sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para dono de negócio, vendedor ou responsável por conteúdo, com campos e limites claros.
