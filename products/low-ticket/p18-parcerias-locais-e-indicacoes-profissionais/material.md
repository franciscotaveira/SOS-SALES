...
## Entrega incluída
Apresentação de parceria, roteiro de contato individual pertinente e quadro de acompanhamento.
...
Use a sequência **Parceria local** como uma semana de teste. Uma peça precisa ter uma intenção observável: informar, esclarecer ou iniciar uma conversa.

| Dia | Intenção | Peça ou ação | Sinal observado |
|---:|---|---|---|
| 1 | Escolha do parceiro | [PREENCHER] | [REGISTRAR] |
| 2 | Contexto da indicação | [PREENCHER] | [REGISTRAR] |
| 3 | Mensagem individual | [PREENCHER] | [REGISTRAR] |
| 4 | Oferta de colaboração | [PREENCHER] | [REGISTRAR] |
| 5 | Registro do contato | [PREENCHER] | [REGISTRAR] |
| 6 | Retorno | [PREENCHER] | [REGISTRAR] |
| 7 | Encerramento | [PREENCHER] | [REGISTRAR] |
