...
## Entrega incluída
Mensagens e rotina de confirmação com data, local, preparo fornecido pelo negócio e resposta esperada.
...
O fluxo **Confirmar** só confirma o que a empresa consegue consultar ou cumprir.

| Etapa | Mensagem ou decisão | Fonte de confirmação |
|---:|---|---|
| 1 | [PREENCHER: convite] | [SISTEMA / RESPONSÁVEL] |
| 2 | [PREENCHER: data e horário] | [SISTEMA / RESPONSÁVEL] |
| 3 | [PREENCHER: local ou canal] | [SISTEMA / RESPONSÁVEL] |
| 4 | [PREENCHER: preparo] | [SISTEMA / RESPONSÁVEL] |
| 5 | [PREENCHER: resposta esperada] | [SISTEMA / RESPONSÁVEL] |
