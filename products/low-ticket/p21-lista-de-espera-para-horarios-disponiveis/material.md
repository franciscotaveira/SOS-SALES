...
**Família:** Agenda e atendimento  
**Para:** negócio de serviços com horários marcados  
**Preço-teste sugerido:** R$ 27,00  
**Versão:** v1.0 · material de aplicação

## O que este produto resolve
Organizar confirmação, remarcação e orientação sem prometer uma disponibilidade não consultada.

## Entrega incluída
Quadro de interessados, critérios de convite e mensagens que só oferecem disponibilidade confirmada.
...
O fluxo **Lista de espera** só confirma o que a empresa consegue consultar ou cumprir.

| Etapa | Mensagem ou decisão | Fonte de confirmação |
|---:|---|---|
| 1 | [PREENCHER: preferência] | [SISTEMA / RESPONSÁVEL] |
| 2 | [PREENCHER: critério de convite] | [SISTEMA / RESPONSÁVEL] |
| 3 | [PREENCHER: disponibilidade confirmada] | [SISTEMA / RESPONSÁVEL] |
| 4 | [PREENCHER: resposta] | [SISTEMA / RESPONSÁVEL] |
| 5 | [PREENCHER: remoção da lista] | [SISTEMA / RESPONSÁVEL] |
