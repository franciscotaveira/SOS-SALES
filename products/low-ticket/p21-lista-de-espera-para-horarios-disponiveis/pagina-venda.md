...
**Para quem é:** negócio de serviços com horários marcados.
...
1. Dor: resolva uma etapa de agenda que costuma gerar retrabalho sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para negócio de serviços com horários marcados, com campos e limites claros.
