...
## Entrega incluída
Modelos de boas-vindas, localização, documentos necessários e instruções práticas.
...
O fluxo **Primeira visita** só confirma o que a empresa consegue consultar ou cumprir.

| Etapa | Mensagem ou decisão | Fonte de confirmação |
|---:|---|---|
| 1 | [PREENCHER: boas-vindas] | [SISTEMA / RESPONSÁVEL] |
| 2 | [PREENCHER: localização] | [SISTEMA / RESPONSÁVEL] |
| 3 | [PREENCHER: documentos] | [SISTEMA / RESPONSÁVEL] |
| 4 | [PREENCHER: preparo] | [SISTEMA / RESPONSÁVEL] |
| 5 | [PREENCHER: confirmação] | [SISTEMA / RESPONSÁVEL] |
