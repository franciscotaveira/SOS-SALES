# Pedido de avaliação e depoimento

> Criar contatos pertinentes depois da compra, com critério, contexto e respeito à preferência do cliente.

**Para quem é:** negócio que já possui clientes e quer cuidar da continuidade.

## Você recebe
- Mensagens para solicitar relato honesto e autorização de uso; sem fabricar avaliações
...
1. Dor: resolva uma oportunidade de continuidade depois da venda sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para negócio que já possui clientes e quer cuidar da continuidade, com campos e limites claros.
