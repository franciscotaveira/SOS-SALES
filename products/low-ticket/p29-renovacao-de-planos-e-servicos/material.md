...
A sequência **Renovação** precisa respeitar o momento e a preferência do cliente. Use apenas contatos que tenham uma razão clara.

| Momento | Intenção | Mensagem ou ação | Critério de parada |
|---:|---|---|---|
| 1 | data | [PREENCHER] | [PREENCHER] |
| 2 | uso | [PREENCHER] | [PREENCHER] |
| 3 | condição | [PREENCHER] | [PREENCHER] |
| 4 | decisão | [PREENCHER] | [PREENCHER] |
