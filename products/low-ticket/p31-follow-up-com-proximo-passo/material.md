...
## Como configurar
A ferramenta **Follow-up** começa com um exemplo fictício. Duplique a aba de exemplo, apague os dados de teste e só então registre dados reais.
...
| Próxima ação | [PREENCHER] |
| Prazo | [PREENCHER] |
| Status | [PREENCHER] |
| Motivo de parada | [PREENCHER] |
