...
## Como configurar
A ferramenta **Desconto** começa com um exemplo fictício. Duplique a aba de exemplo, apague os dados de teste e só então registre dados reais.

### Colunas mínimas
| Coluna | O que registrar |
|---|---|
| Preço cheio | [PREENCHER] |
| Custo variável | [PREENCHER] |
| Desconto | [PREENCHER] |
| Preço final | [PREENCHER] |
| Contribuição | [PREENCHER] |
| Margem | [PREENCHER] |
