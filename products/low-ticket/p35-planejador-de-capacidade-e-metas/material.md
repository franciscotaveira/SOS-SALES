...
## Como configurar
A ferramenta **Capacidade e metas** começa com um exemplo fictício. Duplique a aba de exemplo, apague os dados de teste e só então registre dados reais.
...
| Pessoas | [PREENCHER] |
| Horas | [PREENCHER] |
| Atendimentos | [PREENCHER] |
| Valor médio | [PREENCHER] |
| Conversão | [PREENCHER] |
| Cenário | [PREENCHER] |
