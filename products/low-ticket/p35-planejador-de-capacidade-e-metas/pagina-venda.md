...
> Tirar uma decisão comercial da cabeça e colocar em uma ferramenta simples de usar.

**Para quem é:** dono, autônomo ou gestor de pequena equipe.

## Você recebe
- Simulação de atendimentos, capacidade, valor médio e cenários de conversão informados pelo usuário
...
1. Dor: resolva uma decisão comercial que precisa ficar visível sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para dono, autônomo ou gestor de pequena equipe, com campos e limites claros.
