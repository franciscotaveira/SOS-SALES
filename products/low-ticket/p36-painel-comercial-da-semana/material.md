...
## Entrega incluída
Resumo de oportunidades, vendas, perdas e ações, com roteiro de reunião curta.
...
## Como configurar
A ferramenta **Painel semanal** começa com um exemplo fictício. Duplique a aba de exemplo, apague os dados de teste e só então registre dados reais.

### Colunas mínimas
| Coluna | O que registrar |
|---|---|
| Oportunidades | [PREENCHER] |
| Vendas | [PREENCHER] |
| Perdas | [PREENCHER] |
| Origem | [PREENCHER] |
| Próximas ações | [PREENCHER] |
| Decisões | [PREENCHER] |
