...
## Plano de aplicação
O treinamento **Primeira semana** funciona em uma sessão curta, seguida de observação. O objetivo é criar um padrão observável, não decorar frases.

| Bloco | Atividade | Evidência de conclusão |
|---:|---|---|
| 1 | entender oferta | [O QUE OBSERVAR] |
| 2 | observar conversa | [O QUE OBSERVAR] |
| 3 | praticar pergunta | [O QUE OBSERVAR] |
| 4 | praticar próximo passo | [O QUE OBSERVAR] |
| 5 | revisar | [O QUE OBSERVAR] |
