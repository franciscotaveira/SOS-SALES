...
## Plano de aplicação
O treinamento **Simulações** funciona em uma sessão curta, seguida de observação. O objetivo é criar um padrão observável, não decorar frases.

| Bloco | Atividade | Evidência de conclusão |
|---:|---|---|
| 1 | briefing | [O QUE OBSERVAR] |
| 2 | cliente fictício | [O QUE OBSERVAR] |
| 3 | rodada | [O QUE OBSERVAR] |
| 4 | observação | [O QUE OBSERVAR] |
| 5 | nova rodada | [O QUE OBSERVAR] |
