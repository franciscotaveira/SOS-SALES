...
## Plano de aplicação
O treinamento **Revisão do gestor** funciona em uma sessão curta, seguida de observação. O objetivo é criar um padrão observável, não decorar frases.

| Bloco | Atividade | Evidência de conclusão |
|---:|---|---|
| 1 | clareza | [O QUE OBSERVAR] |
| 2 | contexto | [O QUE OBSERVAR] |
| 3 | informação correta | [O QUE OBSERVAR] |
| 4 | próximo passo | [O QUE OBSERVAR] |
| 5 | feedback | [O QUE OBSERVAR] |
