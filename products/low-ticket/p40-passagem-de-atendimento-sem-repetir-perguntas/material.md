...
## Plano de aplicação
O treinamento **Passagem de atendimento** funciona em uma sessão curta, seguida de observação. O objetivo é criar um padrão observável, não decorar frases.

| Bloco | Atividade | Evidência de conclusão |
|---:|---|---|
| 1 | resumo | [O QUE OBSERVAR] |
| 2 | pendência | [O QUE OBSERVAR] |
| 3 | responsável | [O QUE OBSERVAR] |
| 4 | próxima ação | [O QUE OBSERVAR] |
| 5 | confirmação | [O QUE OBSERVAR] |
