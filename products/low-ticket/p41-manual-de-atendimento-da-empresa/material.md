...
## Plano de aplicação
O treinamento **Manual** funciona em uma sessão curta, seguida de observação. O objetivo é criar um padrão observável, não decorar frases.

| Bloco | Atividade | Evidência de conclusão |
|---:|---|---|
| 1 | responsabilidades | [O QUE OBSERVAR] |
| 2 | tom | [O QUE OBSERVAR] |
| 3 | fontes | [O QUE OBSERVAR] |
| 4 | limites | [O QUE OBSERVAR] |
| 5 | encaminhamentos | [O QUE OBSERVAR] |
