...
## Plano de aplicação
O treinamento **WhatsApp Business** funciona em uma sessão curta, seguida de observação. O objetivo é criar um padrão observável, não decorar frases.

| Bloco | Atividade | Evidência de conclusão |
|---:|---|---|
| 1 | perfil | [O QUE OBSERVAR] |
| 2 | catálogo | [O QUE OBSERVAR] |
| 3 | etiquetas | [O QUE OBSERVAR] |
| 4 | respostas rápidas | [O QUE OBSERVAR] |
| 5 | revisão | [O QUE OBSERVAR] |
