...
> Dar ao time uma forma observável de praticar, atender e passar a conversa adiante.

**Para quem é:** dono ou líder que precisa orientar vendedores.

## Você recebe
- Tutorial de configuração dos recursos disponíveis, checklist e exemplos de organização; revisar versão antes de produzir
...
1. Dor: resolva um padrão que o time consegue praticar sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para dono ou líder que precisa orientar vendedores, com campos e limites claros.
