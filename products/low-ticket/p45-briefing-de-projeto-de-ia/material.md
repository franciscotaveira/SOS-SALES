...
O template **Briefing de projeto** deve ser preenchido junto do cliente e aprovado antes de iniciar a próxima etapa.

| Campo | Registro do projeto | Responsável |
|---|---|---|
| processo atual | [PREENCHER] | [PREENCHER] |
| usuário | [PREENCHER] | [PREENCHER] |
| fontes | [PREENCHER] | [PREENCHER] |
| integrações | [PREENCHER] | [PREENCHER] |
| risco | [PREENCHER] | [PREENCHER] |
| viabilidade | [PREENCHER] | [PREENCHER] |
