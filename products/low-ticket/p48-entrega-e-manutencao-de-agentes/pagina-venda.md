...
> Vender e entregar um projeto de ia com escopo, responsabilidade e manutenção explícitos.

**Para quem é:** freelancer, consultor ou pequena agência de automação.

## Você recebe
- Modelo de documentação final, registro de alterações, aceite e definição de atendimento de suporte
...
1. Dor: resolva uma etapa profissional de implantação de IA sem começar de uma página em branco.
2. Resultado: saia com um artefato preenchido para usar na próxima conversa.
3. Identidade: feito para freelancer, consultor ou pequena agência de automação, com campos e limites claros.
