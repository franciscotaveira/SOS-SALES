...
ssh "${VPS_ALIAS}" \
  "test ! -e '${REMOTE_RELEASE}' && test ! -e '${REMOTE_STAGING}' && mkdir -p '${REMOTE_STAGING}/web/dist' '${REMOTE_STAGING}/api/dist' '${REMOTE_STAGING}/api/node_modules' '${REMOTE_STAGING}/api/supabase/migrations' '${REMOTE_STAGING}/certs' '${REMOTE_STAGING}/scripts'"
