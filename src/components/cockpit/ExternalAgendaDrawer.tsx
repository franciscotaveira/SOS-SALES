...
export const SALON_SERVICES: ServiceDefinition[] = [
  {
    ...
    priceEstimated: 'R$ 59,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Lavagem especial com massagem capilar e escova lisa alinhada.',
  },
  {
    id: 'escova_modelada',
    ...
    maxDurationMinutes: 60,
    durationLabel: '45 min',
    priceEstimated: 'R$ 69,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Finalização trabalhada com ondas marcadas ou pontas modeladas.',
  },
  {
    id: 'corte_com_escova',
    ...
    maxDurationMinutes: 60,
    durationLabel: '45 min',
    priceEstimated: 'R$ 110,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Visagismo de corte + lavagem especial + escova modelada.',
  },
  {
    id: 'tratamento_labrizza',
    name: 'Hidratação LaBrizza',
    category: 'cabelo',
    minDurationMinutes: 40,
    maxDurationMinutes: 60,
    durationLabel: '40 min',
    priceEstimated: 'R$ 145,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Nutrição profunda e brilho imediato com linha profissional LaBrizza.',
  },
  {
    id: 'tratamento_truss_ozonio',
    name: 'Truss com Vapor de Ozônio',
    category: 'cabelo',
    minDurationMinutes: 40,
    maxDurationMinutes: 60,
    durationLabel: '40 min',
    priceEstimated: 'R$ 155,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Tratamento capilar intensivo Truss potencializado com ozonioterapia.',
  },
  {
    id: 'tratamento_coreano',
    name: 'Tratamento Capilar Coreano',
    category: 'cabelo',
    minDurationMinutes: 50,
    maxDurationMinutes: 70,
    durationLabel: '50 min',
    priceEstimated: 'R$ 170,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Protocolo coreano de reconstrução, densidade e alinhamento dos fios.',
  },
  {
    id: 'penteado_basico',
    ...
    priceEstimated: 'R$ 100,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Tranças, semi-presos e composições para eventos casuais.',
  },
  {
    id: 'penteado_premium',
    name: 'Penteado Produção Premium',
    category: 'cabelo',
    minDurationMinutes: 60,
    maxDurationMinutes: 90,
    durationLabel: '60 min',
    priceEstimated: 'R$ 150,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Penteados estruturados de alta fixação para formaturas e casamentos.',
  },
  {
    id: 'retoque_raiz',
    ...
    maxDurationMinutes: 90,
    durationLabel: '60 min',
    priceEstimated: 'A partir de R$ 190,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Cobertura perfeita de fios brancos com coloração profissional.',
  },
  {
    id: 'coloracao_completa',
    name: 'Coloração Completa (Wella/Igora)',
    category: 'cabelo',
    minDurationMinutes: 60,
    maxDurationMinutes: 90,
    durationLabel: '60 min',
    priceEstimated: 'A partir de R$ 259,00',
    applicableRoles: ['Cabeleireiro(a)'],
    description: 'Transformação de cor global com linhas Wella e Igora Royal.',
  },
  {
    ...
    maxDurationMinutes: 60,
    durationLabel: '45 min',
    priceEstimated: 'R$ 50,00',
    applicableRoles: ['Manicure'],
    description: 'Cutilagem impecável e esmaltação tradicional.',
  },
  {
    ...
    priceEstimated: 'R$ 50,00',
    applicableRoles: ['Manicure'],
    description: 'Cuidado completo dos pés, esfoliação e esmaltação.',
  },
  {
    id: 'esmaltacao_gel',
    name: 'Esmaltação em Gel (Mãos ou Pés)',
    category: 'unhas',
    ...
    priceEstimated: 'R$ 150,00',
    applicableRoles: ['Manicure'],
    description: 'Alta durabilidade de até 20 dias, brilho espelhado e secagem em cabine LED.',
  },
  {
    id: 'plastica_dos_pes',
    ...
    maxDurationMinutes: 75,
    durationLabel: '60 min',
    priceEstimated: 'R$ 140,00',
    applicableRoles: ['Manicure'],
    description: 'Remoção de calosidades, rachaduras e renovação celular da pele dos pés.',
  },
  {
    ...
    description: 'Mapeamento facial visagista e alinhamento das sobrancelhas.',
  },
  {
    id: 'design_henna',
    ...
    durationLabel: '40 min',
    priceEstimated: 'R$ 70,00',
    applicableRoles: ['Maquiador(a)'],
    description: 'Design personalizado com pigmentação temporária para preenchimento de falhas.',
  },
  {
    id: 'brow_lamination',
    ...
    priceEstimated: 'R$ 150,00',
    applicableRoles: ['Maquiador(a)'],
    description: 'Alinhamento dos fios naturais para efeito volumoso e moderno.',
  },
  {
    id: 'lash_lifting',
    name: 'Lash Lifting',
    ...
    maxDurationMinutes: 75,
    durationLabel: '60 min',
    priceEstimated: 'R$ 165,00',
    applicableRoles: ['Maquiador(a)'],
    description: 'Curvatura e hidratação dos cílios naturais com efeito rímel duradouro.',
  },
  {
    id: 'make_casual',
    name: 'Maquiagem Casual',
    category: 'maquiagem',
    minDurationMinutes: 60,
    maxDurationMinutes: 75,
    durationLabel: '60 min',
    priceEstimated: 'R$ 178,00',
    applicableRoles: ['Maquiador(a)'],
    description: 'Make leve, elegante e resistente para o dia ou reuniões.',
  },
  {
    id: 'make_premium',
    name: 'Maquiagem Produção Premium',
    category: 'maquiagem',
    minDurationMinutes: 60,
    maxDurationMinutes: 90,
    durationLabel: '60 min',
    priceEstimated: 'R$ 220,00',
    applicableRoles: ['Maquiador(a)'],
    description: 'Produção completa com contorno, cílios postiços e selagem à prova d\'água.',
  },
  {
    id: 'depilacao_buco',
    ...
    priceEstimated: 'R$ 15,00',
    applicableRoles: ['Maquiador(a)'],
    description: 'Depilação facial delicada da região do buço.',
  },
];
...
export function detectServiceFromText(text: string): string {
  ...
  if (lower.includes('lash') || lower.includes('cílio') || lower.includes('cilios') || lower.includes('lifting')) return 'lash_lifting';
  if (lower.includes('brow') || lower.includes('lamination')) return 'brow_lamination';
  if (lower.includes('henna')) return 'design_henna';
  if (lower.includes('sobrancelha')) return 'design_sobrancelhas';
  if (lower.includes('gel') || lower.includes('russa') || lower.includes('alongamento') || lower.includes('fibra')) return 'esmaltacao_gel';
  if (lower.includes('plástica') || lower.includes('plastica') || lower.includes('rachadura') || lower.includes('calos')) return 'plastica_dos_pes';
  if (lower.includes('corean') || lower.includes('coreia')) return 'tratamento_coreano';
  if (lower.includes('ozônio') || lower.includes('ozonio') || lower.includes('truss')) return 'tratamento_truss_ozonio';
  if (lower.includes('labrizza') || lower.includes('brizza') || lower.includes('hidrata')) return 'tratamento_labrizza';
  if (lower.includes('corte')) return 'corte_com_escova';
  if (lower.includes('raiz') || lower.includes('branco')) return 'retoque_raiz';
  if (lower.includes('colora') || lower.includes('pintar') || lower.includes('tinta') || lower.includes('wella') || lower.includes('igora')) return 'coloracao_completa';
  if (lower.includes('penteado') || lower.includes('casamento') || lower.includes('formatura') || lower.includes('madrinha')) return 'penteado_premium';
  ...
  if (lower.includes('make') || lower.includes('maquiag')) return 'make_casual';
  if (lower.includes('buço') || lower.includes('buco')) return 'depilacao_buco';
  if (lower.includes('modelada') || lower.includes('babyliss') || lower.includes('cachos') || lower.includes('onda')) return 'escova_modelada';
...
export const EXTERNAL_AGENDA_PRESETS: Record<ExternalAgendaProvider, { label: string; defaultUrl: string; placeholder: string; desc: string }> = {
  ...
  trinks: {
    ...
    desc: 'Painel e página de agendamento Trinks da unidade Haven.',
  },
  calendly: {
...
export function getExternalAgendaConfig(wsId: string): ExternalAgendaConfig {
  ...
  if (isHaven) {
    return {
      ...
      url: 'https://www.trinks.com/haven-escovaria-e-esmalteria',
      autoSyncMinutes: 15,
