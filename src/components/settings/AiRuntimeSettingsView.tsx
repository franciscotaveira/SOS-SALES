  ...
  return (
    <form onSubmit={save} className="mx-auto max-w-3xl space-y-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
      <div className="flex items-start gap-3 border-b border-slate-100 pb-4">
        ...
        <div><h2 className="text-sm font-bold text-slate-900">IA própria SOS Vendas</h2><p className="mt-1 text-xs text-slate-500">Responsável pelo atendimento automático, com orientações publicadas por empresa e transferência para a equipe quando necessário.</p></div>
      </div>
