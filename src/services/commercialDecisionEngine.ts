...
export const COMMERCIAL_STAGES: Record<CommercialStage, StageInfo> = {
  ...
  negotiation: {
    ...
    description: 'Tratando objeções de preço, condições de pagamento ou alinhamento final.',
    requiredFacts: ['objeção identificada', 'condição proposta'],
  },
  won: {
    key: 'won',
  ...
  lost: {
    ...
    description: 'Lead não respondeu ou optou por não fechar.',
